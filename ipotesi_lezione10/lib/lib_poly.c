...
int inserisci_elemento_polinomio(struct polinomio* poly){
    ...
    poly->vett = realloc(poly->vett,(poly->size+1) * sizeof(int));
...
void carica_polinomio_stringa(char *s, struct polinomio* poly){
    ...
    // Alloco il vettore dinmamico
    poly->vett = malloc(poly->size * sizeof(int));
...
void carica_polinomio(struct polinomio* poly){
    ...
    carica_polinomio_stringa(s, poly);
}
...
void somma_polinomi(const struct polinomio* a, const struct polinomio* b, struct polinomio* r){
    ...
    r->vett = malloc(r->size * sizeof(int));
